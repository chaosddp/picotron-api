...
--- @overload fun(pitch:number, inst:number, vol:number, effect:number, effect_p:number, channel:number, retrig:boolean)
--- @overload fun(pitch:number, inst:number, vol:number, effect:number, effect_p:number, channel:number)
--- @overload fun(pitch:number, inst:number, vol:number, effect:number, effect_p:number)
--- @overload fun(pitch:number, inst:number, vol:number, effect:number)
--- @overload fun(pitch:number, inst:number, vol:number)
--- @overload fun(pitch:number, inst:number)
--- @overload fun(pitch:number)
--- @overload fun()
